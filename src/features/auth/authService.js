...
const API_URL = "https://plain-dirndl-pike.cyclic.app/api/users/";

const MAIL_URL = "https://plain-dirndl-pike.cyclic.app/send_recovery_email/";
...
const updateAtc = async (userId, token) => {
  const config = {
    headers: {
      Authorization: `Bearer ${token}`,
    },
